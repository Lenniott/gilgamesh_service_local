"""
Vectorization module for processing existing videos.

This module contains the VectorizeExistingVideos class that handles
vectorizing existing videos in the database that haven't been vectorized yet.
"""
